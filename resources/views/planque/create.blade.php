<x-app-layout>
    ...
    <form action="{{ route('planques.store') }}" method="POST">
        @csrf
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Code:</strong>
                    <input type="text" name="code" class="form-control" placeholder="Entrez un Code">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Type :</strong>
                    <input type="text" class="form-control" name="type" placeholder="Entrez un type">
                </div>
            </div>
